...
В случае ручного запуска проекта необходимо установить все зависимости. (_используйте файл `requirements.txt` в корне проекта: `pip install -r requirements.txt`_).  
